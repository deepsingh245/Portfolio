...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 flex h-full w-full flex-col overflow-hidden rounded-xl border",
        className
      )}
    >
      <div className="border-border flex shrink-0 flex-col gap-y-2 border-b p-4">
      ...
      <pre className="min-h-0 flex-1 overflow-hidden p-4">
        <code className="grid h-full gap-y-1 overflow-y-auto overflow-x-hidden whitespace-pre-wrap break-words pr-1">
          {wrappedChildren}
        </code>
      </pre>
    </div>
